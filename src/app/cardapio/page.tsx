      ...
      <main className="px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        <div className="mx-auto max-w-6xl">
          <div className="mb-8 text-center sm:mb-12">
            <h1 className="text-3xl font-bold tracking-tight text-dark-900 dark:text-white sm:text-4xl lg:text-5xl">
              Nosso Cardápio
            </h1>
            <p className="mx-auto mt-3 max-w-2xl text-sm text-dark-600 dark:text-dark-300 sm:mt-4 sm:text-base">
