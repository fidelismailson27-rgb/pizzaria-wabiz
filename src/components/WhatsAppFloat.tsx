...
export default function WhatsAppFloat({
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 rounded-full bg-[#25D366] px-5 py-3 text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl md:animate-pulse-glow md:rounded-full"
