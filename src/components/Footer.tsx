...
const footerLinks = {
  cardapio: [
    { name: 'Clássicas', href: '/cardapio?categoria=classica' },
    { name: 'Especiais', href: '/cardapio?categoria=especial' },
    { name: 'Doces', href: '/cardapio?categoria=doce' },
    { name: 'Bebidas', href: '/cardapio?categoria=bebida' },
  ],
  institucional: [
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/60">
              <li>📍 Av. Embaixador Assis Chateaubriand, 437</li>
              <li>📍 Jd. Ouro Preto - Taboão da Serra - SP</li>
              <li>📞 WhatsApp: 11 94744-5932</li>
              <li>📞 Fixo: 11 4701-2612</li>
              <li>📞 Fixo: 11 4701-9220</li>
              <li>📞 Fixo: 11 4787-7944</li>
            </ul>
